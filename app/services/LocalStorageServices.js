...
import {
  encryptJson,
  encryptFieldUsingAES,
  decryptFieldUsingAES,
} from './EncryptDecryptServices';
...
function _setLicenseStatus(licInfo) {
  safeSetItem('licStatus', licInfo);
}

function _setHospitalType(licInfo) {
  safeSetItem('hospitalType', licInfo);
}

function _setHospitalLimit(limit) {
  safeSetItem('hospitalLimit', limit);
}

function _setHospitalName(licInfo) {
  safeSetItem('hospitalName', licInfo);
}

function _setGlobalSetting(globalsetting) {
  safeSetItem('globalSetting', JSON.stringify(globalsetting));
}

function _setLoader(loaderState) {
  safeSetItem('loader', loaderState);
}

function _setdepartmentDisplay(departmentDisplay) {
  safeSetItem('departmentDisplay', departmentDisplay);
}
